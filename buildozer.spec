...
# p4a webview bootstrap 默认加载 file:///android_asset/_load.html（含三根 #aaaaff 竖条），
# 只要把自定义的 assets/ 目录打进 APK 的 assets/，就会在冷/热启动都生效。
# 这里的 _load.html 背景色与 presplash 一致 (#DFF3FF)，彻底消除紫色三柱。
